...
Here, I found the mean squared error (MSE), which was 93.06924. The smaller the number the better, so this number was not necessarily great. I then ran a k-fold CV on this same model, which had a value of 19262.54. The MSE was higher in CV, which is not good, as it shows that there is over fitting. 
